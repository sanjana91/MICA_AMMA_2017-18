...
input_csv.df <- read.csv(file="C:\\Users\\hp hp\\Documents\\GitHub\\MICA_AMMA_2017-18\\binary.csv")
View(input_csv.df)
# reset directory and read file
setwd("C:\\Users\\hp hp\\Documents\\GitHub\\MICA_AMMA_2017-18")
...
write.csv(tt, "C:\\Users\\hp hp\\Documents\\GitHub\\MICA_AMMA_2017-18\\mtcars.csv",
          row.names=F
)
