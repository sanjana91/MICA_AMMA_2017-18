...
setwd("C:\\Users\\hp hp\\Documents\\GitHub\\MICA_AMMA_2017-18\\R for Data Science\\data")
...
summary(sm_card_balance$billed_3m)
...
sm_card_balance$dt_var1 <- sm_card_balance$Payment_3>1198

table(sm_card_balance$dt_var1,sm_card_balance$Pred_bill_drop)
...
sm_card_balance1$AGE_cat <- cut(sm_card_balance1$AGE,
                                quantile(sm_card_balance1$AGE, probs = seq(0,1,0.2)))
sm_card_balance1$Pre_billed_amt_3m_cat <- cut(sm_card_balance1$Pre_billed_amt_3m,
                                quantile(sm_card_balance1$Pre_billed_amt_3m, probs = seq(0,1,0.2)))
sm_card_balance1$Payment_1_cat <- cut(sm_card_balance1$Payment_1,
                                      unique(quantile(sm_card_balance1$Payment_1, probs = seq(0,1,0.2))))
